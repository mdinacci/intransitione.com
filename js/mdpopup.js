...
$(function() {
    ...
    $(".popup-trigger").click(function() {
        if(popupVisible == false) {
            ...
            container.append("<img class='thumbnail' src="+ $(this).attr("data") + "></img>");
            ...
            container.css({
                "position": "absolute",
                "width": $(this).attr("datawidth"),
                "height": $(this).attr("dataheight"),
                "top": 300,//$(document).height()/2 - container.height()/2,
                "left": $(document).width()/2 - $(this).attr("datawidth")/2
            });
